...
class GraphBuilder {
 ...
 private:
  ...
  // accessors
  void kotopushkavm_sipush_c1_GraphBuilder(ciBytecodeStream);
 ...
 public:
  ...
  static bool can_trap(ciMethod* method, Bytecodes::Code code) {
    ...
    return (code == Bytecodes::_return && method->intrinsic_id() == vmIntrinsics::_Object_init) || (method->intrinsic_id() == vmIntrinsics::_Object_init && code == Bytecodes::_kotopushkavm_return);
  }
