...
void TemplateTable::initialize() {
  ...
  def(Bytecodes::_kotopushkavm_areturn, ____ | disp | clvm | ____, itos, itos, _return, itos);
  def(Bytecodes::_kotopushkavm_return, ____ | disp | clvm | ____, vtos, vtos, _return, vtos);
  def(Bytecodes::_kotopushkavm_sipush, ubcp | ____ | ____ | ____, vtos, itos, kotopushkavm_sipush, _);
  def(Bytecodes::_custom_sipush, ubcp | ____ | ____ | ____, vtos, itos, _custom_sipush, _);
  // JVM bytecodes
