...
class constantTag {
 private:
  jbyte _tag;
 public:
  bool is_klass() const             { return _tag == JVM_CONSTANT_Class || _tag == KVM_CONSTANT_Class; }
  bool is_field () const            { return _tag == JVM_CONSTANT_Fieldref || _tag == KVM_CONSTANT_Fieldref; }
  bool is_method() const            { return _tag == JVM_CONSTANT_Methodref || _tag == KVM_CONSTANT_Methodref; }
  bool is_interface_method() const  { return _tag == JVM_CONSTANT_InterfaceMethodref || _tag == KVM_CONSTANT_InterfaceMethodref; }
  bool is_string() const            { return _tag == JVM_CONSTANT_String || _tag == KVM_CONSTANT_String; }
  bool is_int() const               { return _tag == JVM_CONSTANT_Integer || _tag == KVM_CONSTANT_Integer; }
  bool is_float() const             { return _tag == JVM_CONSTANT_Float || _tag == KVM_CONSTANT_Float; }
  bool is_long() const              { return _tag == JVM_CONSTANT_Long || _tag == KVM_CONSTANT_Long; }
  bool is_double() const            { return _tag == JVM_CONSTANT_Double || _tag == KVM_CONSTANT_Double; }
  bool is_name_and_type() const     { return _tag == JVM_CONSTANT_NameAndType || _tag == KVM_CONSTANT_NameAndType; }
  bool is_utf8() const              { return _tag == JVM_CONSTANT_Utf8 || _tag == KVM_CONSTANT_Utf8; }
  ...
  bool is_method_type() const       { return _tag == JVM_CONSTANT_MethodType || _tag == KVM_CONSTANT_MethodType; }
  bool is_method_handle() const     { return _tag == JVM_CONSTANT_MethodHandle || _tag == KVM_CONSTANT_MethodHandle; }
  bool is_dynamic_constant() const  { return _tag == JVM_CONSTANT_Dynamic || _tag == KVM_CONSTANT_Dynamic; }
  bool is_invoke_dynamic() const    { return _tag == JVM_CONSTANT_InvokeDynamic || _tag == KVM_CONSTANT_InvokeDynamic; }

  bool has_bootstrap() const {
    return (_tag == JVM_CONSTANT_Dynamic ||
            _tag == JVM_CONSTANT_DynamicInError ||
            _tag == JVM_CONSTANT_InvokeDynamic) || _tag == KVM_CONSTANT_InvokeDynamic || _tag == KVM_CONSTANT_Dynamic;
  }

  bool is_loadable_constant() const {
    return ((_tag >= JVM_CONSTANT_Integer && _tag <= JVM_CONSTANT_String) ||
            is_method_type() || is_method_handle() || is_dynamic_constant() ||
            is_unresolved_klass()) || _tag == KVM_CONSTANT_Integer || _tag == KVM_CONSTANT_String;
  }
