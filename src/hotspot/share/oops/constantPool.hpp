...
class ConstantPool : public Metadata {
 ...
 public:
  ...
  void lol_klass_index_at_put(int cp_index, int name_index) {
      tag_at_put(cp_index, JVM_CONSTANT_ClassIndex);
      *int_at_addr(cp_index) = name_index;
  }
  ...
  void lol_method_handle_index_at_put(int cp_index, int ref_kind, int ref_index) {
      tag_at_put(cp_index, KVM_CONSTANT_MethodHandle);
      *int_at_addr(cp_index) = ((jint)ref_index << 16) | ref_kind;
  }
  ...
  void lol_method_type_index_at_put(int cp_index, int ref_index) {
      tag_at_put(cp_index, KVM_CONSTANT_MethodType);
      *int_at_addr(cp_index) = ref_index;
  }
  ...
  void lol_dynamic_constant_at_put(int cp_index, int bsms_attribute_index, int name_and_type_index) {
      tag_at_put(cp_index, KVM_CONSTANT_Dynamic);
      *int_at_addr(cp_index) = ((jint)name_and_type_index << 16) | bsms_attribute_index;
  }
  ...
  void lol_invoke_dynamic_at_put(int cp_index, int bsms_attribute_index, int name_and_type_index) {
      tag_at_put(cp_index, KVM_CONSTANT_InvokeDynamic);
      *int_at_addr(cp_index) = ((jint)name_and_type_index << 16) | bsms_attribute_index;
  }
  ...
  void lol_unresolved_string_at_put(int cp_index, Symbol* s) {
      assert(s->refcount() != 0, "should have nonzero refcount");
      // Note that release_tag_at_put is not needed here because this is called only
      // when constructing a ConstantPool in a single thread, with no possibility
      // of concurrent access.
      tag_at_put(cp_index, KVM_CONSTANT_String);
      *symbol_at_addr(cp_index) = s;
  }
  ...
  void lol_int_at_put(int cp_index, jint i) {
      tag_at_put(cp_index, KVM_CONSTANT_Integer);
      *int_at_addr(cp_index) = i;
  }
  ...
  void lol_long_at_put(int cp_index, jlong l) {
      tag_at_put(cp_index, KVM_CONSTANT_Long);
      // *long_at_addr(which) = l;
      Bytes::put_native_u8((address)long_at_addr(cp_index), *((u8*)&l));
  }
  ...
  void lol_float_at_put(int cp_index, jfloat f) {
      tag_at_put(cp_index, KVM_CONSTANT_Float);
      *float_at_addr(cp_index) = f;
  }
  ...
  void lol_double_at_put(int cp_index, jdouble d) {
      tag_at_put(cp_index, JVM_CONSTANT_Double);
      // *double_at_addr(which) = d;
      // u8 temp = *(u8*) &d;
      Bytes::put_native_u8((address)double_at_addr(cp_index), *((u8*)&d));
  ...
  void lol_string_index_at_put(int cp_index, int string_index) {
      tag_at_put(cp_index, JVM_CONSTANT_StringIndex);
      *int_at_addr(cp_index) = string_index;
  }
  ...
  void lol_field_at_put(int cp_index, int class_index, int name_and_type_index) {
      tag_at_put(cp_index, KVM_CONSTANT_Fieldref);
      *int_at_addr(cp_index) = ((jint)name_and_type_index << 16) | class_index;
  }
  ...
  void lol_method_at_put(int cp_index, int class_index, int name_and_type_index) {
      tag_at_put(cp_index, KVM_CONSTANT_Methodref);
      *int_at_addr(cp_index) = ((jint)name_and_type_index << 16) | class_index;
  }
  ...
  void lol_interface_method_at_put(int cp_index, int class_index, int name_and_type_index) {
      tag_at_put(cp_index, KVM_CONSTANT_InterfaceMethodref);
      *int_at_addr(cp_index) = ((jint)name_and_type_index << 16) | class_index;  // Not so nice
  }
  ...
  void lol_name_and_type_at_put(int cp_index, int name_index, int signature_index) {
      tag_at_put(cp_index, KVM_CONSTANT_NameAndType);
      *int_at_addr(cp_index) = ((jint)signature_index << 16) | name_index;  // Not so nice
  }
