...
class Bytecodes: AllStatic {
 public:
  enum Code {
    ...
    _kotopushkavm_areturn = 203, // 0xcb
    _kotopushkavm_return  = 204, // 0xcc
    _kotopushkavm_sipush  = 205, // 0xcd
    _custom_sipush        = 206,
 ...
 public:
  ...
  static bool        is_return      (Code code)    { return (_ireturn <= code && code <= _return) || code == _kotopushkavm_areturn || code == _kotopushkavm_return; }
